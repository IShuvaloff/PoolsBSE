...
function createPageMain() {
  ...
  // ? тело
  const main = el('main.main', [panelMainServices(), panelMainFeatures(), panelMainProjects('main'), panelMainAbout(), panelMainQuestion(), panelMainContacts()]);
...
function createPagePools() {
  ...
  // ? тело
  const main = el('main.main', [panelPoolsTypes(), panelPoolsAbout_panelMainAbout(), panelMainProjects('pools')]);
