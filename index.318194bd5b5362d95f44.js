...
var phone_symbol = new (browser_symbol_default())({
  ...
  "use": "phone-usage",
  "viewBox": "0 0 18 18",
  "content": "<symbol xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" viewBox=\"0 0 18 18\" id=\"phone\"><path fill=\"#fff\" d=\"m11.706 12.425 1.4-1.4a1.369 1.369 0 0 1 1.463-.3l1.706.681a1.363 1.363 0 0 1 .85 1.25v3.125a1.355 1.355 0 0 1-1.425 1.344C3.744 16.381 1.331 6.256.875 2.381A1.356 1.356 0 0 1 2.231.875H5.25a1.35 1.35 0 0 1 1.25.85l.681 1.706a1.35 1.35 0 0 1-.293 1.463l-1.4 1.4s.806 5.456 6.218 6.131Z\" /></symbol>"
});
...
function panelMainAbout() {
  ...
  const photo = elementPhoto(photo_about_namespaceObject);
...
;// CONCATENATED MODULE: ./src/js/elements/elementFooterMenuItem.js


function elementFooterMenuItem(id) {
  const item = getMenuItem(id);
  if (!item) return;
  return el('li.footer__menu-item', [item.caption]);
}
;// CONCATENATED MODULE: ./src/js/panels/panelFooterMenu.js



function panelFooterMenu() {
...
function panelFooterTop() {
  return el('.footer__top', [panelFooterLogo('footer'), panelFooterMenu(), panelFooterPlaces(), panelFooterContacts()]);
}
