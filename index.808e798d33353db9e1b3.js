...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.button{display:flex;justify-content:center;align-items:center;flex-wrap:wrap;padding:10px;border:3px solid gray;border-radius:10px;background-color:gray;font-family:Arial,Verdana,sans-serif;font-style:normal;font-weight:500;font-size:18px;line-height:22px;letter-spacing:.02em;color:#000;transition:background-color .2s ease-in-out, border-color .2s ease-in-out}.button--transparent{background-color:rgba(0,0,0,0)}.button:focus,.button:hover{background-color:#d3d3d3;border-color:#d3d3d3}.button svg{fill:#000;stroke:#000;stroke-width:3px;height:100%;width:100%}`, ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_URL_IMPORT_21___ = new URL(/* asset import */ __webpack_require__(4054), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_22___ = new URL(/* asset import */ __webpack_require__(6316), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(6316), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_0___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.header{position:relative}.header__bg{position:absolute;top:0;left:0;right:0;z-index:-1;background-image:url(${___CSS_LOADER_URL_REPLACEMENT_0___});background-position:left bottom;background-repeat:repeat-x;background-size:auto 575px;width:100vw;height:565px}.header__top{display:flex;justify-content:flex-start;align-items:center;padding-top:53px;padding-bottom:51px}.header__burger{flex-shrink:0;margin-right:102px;border:none;width:40px;height:28px}.header__burger svg{stroke:#fff;transition:stroke .2s ease-in-out}.header__burger:focus svg,.header__burger:hover svg{stroke:#89bcf6}.header__contacts{display:flex;justify-content:flex-end;align-items:center;margin-left:auto}.header__contacts--socials{display:flex;justify-content:flex-start;align-items:center;margin-right:133px}.header__contacts--socials .contact-social:not(:last-child){margin-right:40px}.header__contacts--phones{margin-right:82px}.header__main{display:grid;grid-template-columns:770px 1fr;grid-template-areas:"title photo" "menu photo" "calculate photo";grid-gap:0 40px}.header__title{grid-area:title;min-height:153px;font-family:"Open Sans";font-style:normal;font-weight:600;font-size:40px;line-height:54px;letter-spacing:.02em;color:#fff}.header__menu{grid-area:menu}.header__calculate{grid-area:calculate}.header__photo{grid-area:photo;display:flex;justify-content:flex-end;align-items:flex-start;padding-top:25px;overflow:hidden;width:100%;height:100%}.header__photo-img{width:100%;border-radius:10px}.header__icon{position:absolute;bottom:-115px;right:75px;width:145px;height:169px}.menu{display:flex;justify-content:flex-start;align-items:flex-start;flex-wrap:wrap;margin-bottom:135px}.menu__item{display:flex;flex-direction:column;justify-content:flex-start;align-items:center;width:127px;font-family:"Montserrat";font-style:normal;font-weight:500;font-size:13px;line-height:16px;text-align:center;letter-spacing:.02em;color:#000}.menu__item-icon{position:relative;margin-bottom:22px;border-radius:10px;box-sizing:border-box;width:104px;height:104px;background-size:104px 104px;background-position:center center;transition:border-width .1s linear}.menu__item-icon--border{position:absolute;top:0;left:0;border:0 solid rgba(0,0,0,0);border-radius:10px;width:100%;height:100%;transition:border-width .2s ease-in-out, border-color .2s ease-in-out}.menu__item-icon--border-selected{border-width:5px;border-color:#fff}.menu__item-icon--border:focus,.menu__item-icon--border:hover{border-width:5px;border-color:#fff}.calculate{display:flex;flex-direction:column;justify-content:flex-start;align-items:center;margin-right:100px}.calculate__params{display:grid;grid-template-columns:repeat(3, 1fr);grid-template-rows:repeat(2, 1fr);grid-gap:45px;gap:45px;margin-bottom:55px}.calculate__param{display:flex;flex-direction:column;justify-content:flex-start;align-items:flex-start}.calculate__label{margin-bottom:19px;font-family:"Montserrat";font-style:normal;font-weight:500;font-size:16px;line-height:20px;letter-spacing:.02em;color:#000}.calculate__input{padding-bottom:10px;background-color:rgba(0,0,0,0);border:none;border-bottom:1px solid #000;font-family:Montserrat;font-size:14px;font-weight:400;line-height:17px;letter-spacing:.02em}.calculate__btn.btn{margin-bottom:53px;width:276px;height:51px}@media(max-width: 1399.98px){.header__burger{margin-right:70px}.header__contacts--phones,.header__contacts--socials{display:none}.header__main{grid-template-columns:1fr;grid-template-areas:"title" "menu" "calculate"}.header__photo{display:none}.header__calculate{align-items:flex-start;margin-right:0}.header__icon{bottom:-131px;right:24px;width:56px}.calculate__params{gap:45px 80px}.calculate__btn.btn{margin-bottom:36px}.menu{flex-wrap:nowrap;width:100%}}@media(max-width: 1023.98px){.header__top{justify-content:space-between;padding-bottom:70px}.header__contacts{margin-left:20px}.header__title{min-height:130px}.calculate__input{max-width:175px}.menu{justify-content:space-between}.menu__item{flex-shrink:1;width:105px}}@media(max-width: 767.98px){.header__bg{top:auto;bottom:124px}.header__bg::before{content:"";position:absolute;top:-500px;left:0;right:0;bottom:100px;background-color:#0984e2}.header__top{padding-bottom:38px}.header__title{margin-bottom:38px;min-height:0}.calculate{align-items:center}.calculate__params{display:none}.menu{display:grid;grid-template-columns:repeat(3, 1fr);grid-gap:25px 40px;gap:25px 40px;margin-bottom:100px}.menu__item{width:100%}}@media(max-width: 575.98px){.header__contacts{display:none}.header__icon{bottom:-148px;width:31px}.header__title{font-size:30px;line-height:40px}.menu__item-icon{width:87px;height:87px}.menu{grid-template-columns:1fr 1fr;gap:25px 30px}}`, ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* настройки при наведении мышью */
.slider:hover {
  opacity: 1;
}

/* настройки бегунка для всех браузеров, кроме Firefox */
...
;// CONCATENATED MODULE: ./src/assets/img/photos/pool-types/pool-concrete.jpg
const pool_concrete_namespaceObject = __webpack_require__.p + "img\\pool-concrete.5bd6606ac5013f7d42e9.jpg";
;// CONCATENATED MODULE: ./src/assets/img/photos/pool-types/pool-scutal.jpg
const pool_scutal_namespaceObject = __webpack_require__.p + "img\\pool-scutal.0dac9434bc66cceebb57.jpg";
;// CONCATENATED MODULE: ./src/assets/img/photos/pool-types/pool-nonchlorine.jpg
const pool_nonchlorine_namespaceObject = __webpack_require__.p + "img\\pool-nonchlorine.06d8c4d4688af8cb7820.jpg";
;// CONCATENATED MODULE: ./src/assets/img/photos/pool-types/pool-wireframe.jpg
const pool_wireframe_namespaceObject = __webpack_require__.p + "img\\pool-wireframe.968d28036b82ed18d9e3.jpg";
;// CONCATENATED MODULE: ./src/assets/img/photos/pool-types/pool-composite.jpg
const pool_composite_namespaceObject = __webpack_require__.p + "img\\pool-composite.6a319f4fafe22b2221f4.jpg";
;// CONCATENATED MODULE: ./src/assets/img/photos/pool-types/pool-spa.jpg
const pool_spa_namespaceObject = __webpack_require__.p + "img\\pool-spa.003717b219276a2a251b.jpg";
...
const MENU_ITEMS = [{
  ...
  descr: 'Разработка дизайнов и строительство любых бассейнов по вашему желанию',
  ...
  descr: 'Проектирование,  строительство и ремонт общественных и частных бассейнов',
  ...
  descr: 'Удивительные и непревзойденные фонтаны для любого архитектурного коллажа',
...
const FEATURES = [{
  ...
  descr: 'Мы используем только качественные строительные, ландшафтные и растительные материалы.',
  svg: techno
}, {
  id: 'work',
  title: 'Высокую культуру производства работ',
  descr: 'Своевременная уборка и поддержание чистоты при монтаже оборудования и строительстве объекта.',
  svg: work
}, {
  id: 'full',
  title: 'Полный цикл работ "Под Ключ"',
  descr: 'Выполнение всех работ от первоначальной идеи, до конечного воплощения проекта- «под ключ». При реализации проекта мы берем на себя выполнение всех сопутствующих работ.',
  svg: full
}, {
  id: 'price',
  title: 'Гибкую ценовую политику',
  descr: 'Подберём решение которое подходит именно Вам, при комплексных решениях предоставляем скидки и подарки.',
  svg: price
}, {
  id: 'service',
  title: 'Гарантийное и сервисное обслуживание',
  descr: 'Осуществляем гарантийное и постгарантийное обслуживание, воевременная замена оборудования, мониторинг работы систем.',
  svg: service
}, {
  id: 'garantee',
  title: 'Гарантию на все работы',
  descr: 'Наша компания предоставляет гарантию 1-год на посаженные нами растения и проделанные работы.',
  svg: garantee
}];
const PROJECTS = [{
  id: 'pool-1',
...
const POOL_TYPES = [{
  ...
  description: 'Бетонный бассейн предоставляет большой простор для дизайнера (любые размеры и форма). У него имеются конструктивные преимущества, одно из главных – опора для плиты перекрытия пола.',
  features: ['Любые размеры и формы', 'Долгий срок службы', 'Возможность установки дополнительного оборудования'],
  photo: pool_concrete_namespaceObject
}, {
  id: 'scutal',
  title: 'Сборно-щитовые бассейны',
  description: 'Сборный бассейн – это наружный каркас из металлических или пластиковых щитов и выстиланной пленкой внутри. Всесезонный морозостойкий бассейн, который можно использовать зимой или законсервировать.',
  features: ['Простота в монтаже и демонтаже', 'Неприхотливость в уходе', 'Легкость в обслуживании', 'Ремонтопригодность'],
  photo: pool_scutal_namespaceObject
}, {
  id: 'nonchlorine',
  title: 'Безхлорные бассейны',
  description: 'Безхлорный бассейн - бассейн, в котором применяются альтернативные методы регулярной очистки воды, например активным кислородом, озонированием, обработкой ультрафиолетом и др.',
  features: ['Любые размеры и формы', 'Неприхотливость в уходе', 'Легкость в обслуживании'],
  photo: pool_nonchlorine_namespaceObject
}, {
  id: 'composite',
  title: 'Композитные бассейны',
  description: 'Композитный бассейн — это готовая легкая и тонкая (до 30 мм) чаша, состоящая из 6-9 слоев разных материалов, которые равномерно распределяют между собой статическую и динамическую нагрузки.',
  features: ['Устойчивость к влиянию атмосферной среды', 'Практически любая комплектация.', 'Легкость в обслуживании', 'Ремонтопригодность'],
  photo: pool_composite_namespaceObject
}, {
  id: 'wireframe',
  title: 'Каркасные бассейны',
  description: 'Каркасный бассейн - это быстровозводимая конструкция из металлического или пластикового каркаса - стержневой или листовой - и ПВХ чаши. Чаша крепится к каркасу специальной фурнитурой.',
  features: ['Устойчивость к повреждениям', 'Любые размеры и формы', 'Устойчивость к перепадам температур', 'Не самая высокая цена'],
  photo: pool_wireframe_namespaceObject
}, {
  id: 'spa',
  title: 'Спа',
  description: 'Гидромассажный бассейн - это бассейн, оснащенный регулируемой системой подогрева и характеризующийся замкнутым циклом очистки воды. Широко применяются для терапевтического воздействия на тело человека.',
  features: ['Простота эксплуатации', 'Легкость ухода за водой', 'Надежность и долговечность', 'Высокоэффективный массаж'],
  photo: pool_spa_namespaceObject
}];
const SWIPERS = [{
  id: 'projects',
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/js/components/Button/button.sass
var Button_button = __webpack_require__(3667);
;// CONCATENATED MODULE: ./src/js/components/Button/button.sass
...
var button_update = injectStylesIntoStyleTag_default()(Button_button/* default */.Z, button_options);
       ...
       /* harmony default export */ const components_Button_button = (Button_button/* default */.Z && Button_button/* default */.Z.locals ? Button_button/* default */.Z.locals : undefined);
...
class Button {
  ...
  // ? инлайновый svg-код
  _getSvgHtml(svg) {
    return !svg?.id?.trim() ? '' : `<svg viewBox="${svg.viewBox}">
           <use xlink:href="#${svg.id}" />
         </svg>`;
  }
  ...
  constructor({
    ...
    if (classNames?.length) {
      classNames.map(item => item.trim()).forEach(item => this._btn.classList.add(item));
    }
...
var close_btn_symbol = new (browser_symbol_default())({
  ...
  "use": "close-btn-usage",
  "viewBox": "0 0 24 24",
  "content": "<symbol xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" id=\"close-btn\"><path d=\"M22 2 12 12M2 22l10-10m0 0L2.833 2.833 22 22\" /></symbol>"
});
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/sass/_header.sass
var _header = __webpack_require__(4582);
;// CONCATENATED MODULE: ./src/sass/_header.sass
...
_header_options.styleTagTransform = (styleTagTransform_default());
_header_options.setAttributes = (setAttributesWithoutAttributes_default());

      _header_options.insert = insertBySelector_default().bind(null, "head");
    
_header_options.domAPI = (styleDomAPI_default());
_header_options.insertStyleElement = (insertStyleElement_default());

var _header_update = injectStylesIntoStyleTag_default()(_header/* default */.Z, _header_options);




       /* harmony default export */ const sass_header = (_header/* default */.Z && _header/* default */.Z.locals ? _header/* default */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/js/panels/panelHeader.js
...
function panelMainServices() {
  const containerTitle = elementContainer([elementSubtitleServices('Наши услуги')]);
...
function panelMainProjects(pageName) {
...
function panelMainAbout() {
  ...
  const text = el('.about__text-wrapper', [elementTextBlock('Стабильно развивающаяся компания, предоставляющая широкий спектр услуг от строительства бассейнов для загородных домов и участков, до сооружения водных аттракционов, детских площадок и городских фонтанов.', 'about'), elementTextBlock('Компания была основана в 2007 году и за эти годы заняла достойное место на рынке услуг.', 'about'), elementTextBlock('Основной принцип нашей работы заключается в том, что мы учитываем все пожелания клиента.', 'about'), elementTextBlock('При сооружении бассейна, фонтана, искусственного водоёма и т.д.,  мы непременно будем стремиться воплотить в реальность любую Вашу фантазию, можно сказать, Вы будете выступать в качестве дизайнера будущего проекта.', 'about')]);
      ...
      myPoints.forEach(point => {
        const placemark = new maps.GeoObject({
          ...
          properties: {
            // контент метки
            iconContent: 'BSE',
            // ! отображается, если не указана кастомная иконка (см. опции ниже)
...
function panelMainContacts() {
  ...
  const scheduleWrapper = el('.schedule-wrapper', [el('h3.contacts__subtitle.schedule__title', 'Режим работы'), schedule]);
...
function panelDialog({
  ...
  // ! массив объектов {from, to}, со стартовым и конечным индексами символов в title, которые следует выделить
  inputs = [],
  // ! массив объектов {id, placeholder} для создания инпутов
  btnText = '',
  className = ''
}) {
...
;// CONCATENATED MODULE: ./src/js/panels/panelDialogCallOrder.js

function panelDialogCallOrder() {
  return panelDialog({
...
function elementCopyright(className) {
  return el(`p.copyright.${className}__copyright`, `BSE инженерно-технический центр ©${new Date().getFullYear()}. Все права защищены.`);
}
;// CONCATENATED MODULE: ./src/js/panels/panelFooter.js
...
function createPageMain() {
  ...
  // ? тело
  const main = el('main.main.main--main', [panelMainServices(), panelMainFeatures(), panelMainProjects('main'), panelMainAbout(), panelMainQuestion(), panelMainContacts()]);
...
;// CONCATENATED MODULE: ./src/assets/icons/list-item-check.svg


var list_item_check_symbol = new (browser_symbol_default())({
  "id": "list-item-check",
  "use": "list-item-check-usage",
  "viewBox": "0 0 25 19",
  "content": "<symbol xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" viewBox=\"0 0 25 19\" id=\"list-item-check\"><path stroke=\"#0984E2\" stroke-width=\"3\" d=\"M2 8.364 9.412 16 23 2\" /></symbol>"
});
var list_item_check_result = browser_sprite_build_default().add(list_item_check_symbol);
/* harmony default export */ const list_item_check = (list_item_check_symbol);
;// CONCATENATED MODULE: ./src/js/elements/elementListItemCheck.js



function elementListItemCheck(text, className) {
  if (!text.trim()) return;
  const icon = el('.item-check__icon');
  icon.innerHTML = getSvgHtml(list_item_check);
  const caption = el('.item-check__text', text.trim());
  return el(`li.item-check.${className}.${className}--item-check`, [icon, caption]);
}
;// CONCATENATED MODULE: ./src/js/elements/elementCard.js




function elementCard(id, className) {
...
;// CONCATENATED MODULE: ./src/js/panels/panelPoolsTypesCards.js




const CLASSNAME = 'pool-types';
function panelPoolsTypes() {
  const title = el(`.subtitle.${CLASSNAME}__title`, 'Типы возводимых бассейнов любой сложности');
...
;// CONCATENATED MODULE: ./src/assets/img/photos/photo-pools-about.jpg
const photo_pools_about_namespaceObject = __webpack_require__.p + "img\\photo-pools-about.5ebe94ec084b874955c8.jpg";
;// CONCATENATED MODULE: ./src/assets/img/photo-water.png
const photo_water_namespaceObject = __webpack_require__.p + "img\\photo-water.1a975b9fb9d14b9c90a6.png";
;// CONCATENATED MODULE: ./src/js/panels/panelPoolsAbout.js
...
function panelPoolsAbout_panelMainAbout() {
  const title = elementSubtitleLeft('Статья о бассейнах');
  title.classList.add('about__title');
  const text = el('.about__text-wrapper', [elementTextBlock('Обычный размер ванн в плавательном бассейне — 25 или 50 метров. Количество дорожек обычно бывает от 5 до 10. По центру каждой дорожки на дне, а также на торцах ванны делается разметка для того, чтобы пловцам легче было плыть без отклонений от прямолинейного курса. Поперёк ванны на расстоянии 5 м от начала и конца подвешиваются два шнура с флажками, они нужны пловцам на спине — чтобы видеть близость стенки и подготовиться к повороту.', 'about'), elementTextBlock('На расстоянии 15 м от старта поперёк бассейна подвешивается шнур, который падает на воду при фальстарте и останавливает участников. Перед каждой дорожкой в начале и конце бассейна расположены стартовые тумбочки, с них прыгают в воду при старте пловцы кролем, брассом и баттерфляем. На тумбочках имеются рукоятки, за которые держатся пловцы на спине перед стартом. Детские бассейны могут быть любой формы и обычно неглубоки.', 'about')]);
  const photo = elementPhoto(photo_pools_about_namespaceObject, 'about');
  const photoBackside = elementPhoto(photo_water_namespaceObject, 'about');
...
function createPagePools() {
  ...
  // ? тело
  const main = el('main.main.main--pools', [panelPoolsTypes(), panelPoolsAbout_panelMainAbout(), panelMainProjects('pools')]);
...
;// CONCATENATED MODULE: ./src/js/pages/createPageFontains.js
...
function createPageFontains() {
  ...
  // ? тело
  const main = el('main.main.main--fontains', el('.container', 'ИНФОРМАЦИЯ О ВОЗВЕДЕНИИ ФОНТАНОВ...'));
  ...
  // ! обновить отдельные компоненты меню
  // ? обновить кнопки и шапку
  updateHeaderMenu('fontains');
}
;// CONCATENATED MODULE: ./src/js/pages/createPageDewatering.js
...
function createPageDewatering() {
  ...
  // ? тело
  const main = el('main.main.main--dewatering', el('.container', 'ИНФОРМАЦИЯ О СИСТЕМАХ ВОДООТВЕДЕНИЯ...'));
...
;// CONCATENATED MODULE: ./src/js/pages/createPageWatering.js
...
function createPageWatering() {
  ...
  // ? тело
  const main = el('main.main.main--watering', el('.container', 'ИНФОРМАЦИЯ О СОЗДАНИИ СИСТЕМ АВТОПОЛИВА...'));
...
;// CONCATENATED MODULE: ./src/js/pages/createPageLandscaping.js
...
function createPageLandscaping() {
  const burgerMenu = panelBurgerMenu();
  ...
  // ? тело
  const main = el('main.main.main--landscaping', el('.container', 'ИНФОРМАЦИЯ О ЛАНДШАФТНОМ ДИЗАЙНЕ...'));
...
;// CONCATENATED MODULE: ./src/js/pages/createPageArtificial.js
...
function createPageArtificial() {
  ...
  // ? тело
  const main = el('main.main.main--artificial', el('.container', 'ИНФОРМАЦИЯ О СООРУЖЕНИИ ИСКУССТВЕННЫХ ВОДОЁМОВ...'));
...
routing_router.on('/', () => createPage('main')).on('/pools', () => createPage('pools')).on('/artificial', () => createPage('artificial')).on('/fontains', () => createPage('fontains')).on('/dewatering', () => createPage('dewatering')).on('/watering', () => createPage('watering')).on('/landscaping', () => createPage('landscaping'))
// .on('/page/:id', (data) => {
