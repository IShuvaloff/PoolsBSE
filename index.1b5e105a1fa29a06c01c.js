...
function panelBurgerMenu() {
  ...
  const container = el(`.${CLASS_NAME}-container`, [el(`.${CLASS_NAME}`, [closeBtn, elementLogo(CLASS_NAME), panelNavMenu(CLASS_NAME, true), panelSocials(CLASS_NAME), elementOrderCall(CLASS_NAME)])]);
